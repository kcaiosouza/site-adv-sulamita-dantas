			...
			<div>
				...
				<div>
					...
					<div className='flex flex-col w-full px-4 gap-1'>
						...
						<Link href="#" className={`hover:bg-[var(--sidebar-hover-brown)] bg-transparent transition-colors duration-300 rounded-md py-2 px-4 flex items-center gap-2 ${currentPage == "images" ? "bg-[var(--sidebar-hover-brown)]" : ""}`}>
